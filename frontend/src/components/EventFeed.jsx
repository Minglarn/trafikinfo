                                                    ...
                                                    {eventHistory[event.external_id].map((version, vidx) => (
                                                        <div key={vidx} className="relative">
                                                            ...
                                                            <div className="space-y-1">
                                                                ...
                                                                <div className="text-xs text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-900/30 p-2 rounded border border-slate-100 dark:border-slate-800/50">
                                                                    {version.description?.split(' | ').map((d, i) => <p key={i}>{d}</p>)}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ))}
